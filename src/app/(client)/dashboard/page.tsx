                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-orange-100 text-sm leading-relaxed mb-4">
                      Publica tu primera solicitud y recibe presupuestos de profesionales verificados en minutos.
                    </p>
                    <Link
            ...
            {!firstTime && (
              ...
              >
                <div>
                  ...
                  <p className="text-orange-100 text-sm mt-0.5">Recibe hasta 5 presupuestos de profesionales verificados</p>
                </div>
              ...
              <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { n: "2", t: "Recibe propuestas", s: "Profesionales verificados te contactan" },
            ...
            {!firstTime && (
              <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
                ...
                <div className="space-y-1">
                  {[
                    { href: "/mensajes", icon: <MessageSquare className="w-4 h-4 text-blue-500" />, label: "Mis mensajes", badge: unreadCount > 0 ? unreadCount : null },
                    { href: "/solicitudes", icon: <Clock className="w-4 h-4 text-orange-400" />, label: "Historial de solicitudes", badge: null },
                    { href: "/profesionales", icon: <Users className="w-4 h-4 text-emerald-500" />, label: "Directorio de profesionales", badge: null },
                  ].map((item) => (
                    <Link
                      key={item.href}
                      href={item.href}
